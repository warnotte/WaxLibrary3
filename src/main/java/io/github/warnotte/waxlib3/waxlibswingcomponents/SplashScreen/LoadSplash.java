...
public class LoadSplash extends ShadowedWindow
{
	...
	String VersionNumber = null;  //  @jve:decl-index=0:
	...
	public LoadSplash(String fileName, boolean Create_Shadow, boolean FadingSplash, String VersionNum, String CopyrightNotes)
	{
		...
		this.Create_Shadow=Create_Shadow;
	...
	//	boolean support = com.sun.awt.AWTUtilities.isTranslucencySupported(com.sun.awt.AWTUtilities.Translucency.TRANSLUCENT);
		...
		if (support==true)
		{
			Thread t = new Thread()
			{
				...
				public void run()
				{
					for (int i = 0 ; i < 100;i++)
					{
						//com.sun.awt.AWTUtilities.setWindowOpacity(LoadSplash.this, (float)i/100.0f);
						
						LoadSplash.this.setOpacity(i/100.0f);
	...
	public static void main(String[] args) {
        try {
        	final LoadSplash window = new LoadSplash("splash.jpg", true, true, "4.3", "Copyright");
