...
public abstract class PanelGraphiqueBaseBase extends PanelGraphiqueBase<Object> implements KeyListener, MouseListener, MouseWheelListener, MouseMotionListener
{
	...
	// Configuration CAD Workshop : Clic DROIT pour sélection, clic GAUCHE pour action
	protected int BUTTON_SELECTION_MASK = MouseEvent.BUTTON3;  // Clic DROIT pour sélection
	protected int BUTTON_SCROLL_MASK    = MouseEvent.BUTTON2;  // Bouton milieu pour scroll
	protected int BUTTON_POPUP_MASK      = MouseEvent.BUTTON3;  // Double-clic droit pour popup (TODO)
	...
	public PanelGraphiqueBaseBase(CurrentSelectionContext context, ConfigurationGeneral generalConfig, ConfigurationColor colorConfig)
	{
		...
		requestFocus(true);
		// Use JPopupMenu directly instead of PanelGraphiquePopupMenu (type incompatibility with copied class)
